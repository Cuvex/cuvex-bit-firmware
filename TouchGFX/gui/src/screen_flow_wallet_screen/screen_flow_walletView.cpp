...
void screen_flow_walletView::tickEventScreen()
{
	...
	if((s3_getWords.isVisible() == true) && (dice_roll.isVisible() == true) && (keyboard1.isVisible() == true) && (keyboard1.getBuffer()[0] != 0x00))
	{
		switch(current_dice)
		{
...
void screen_flow_walletView::btnInfoWalletPressed()
{
	...
	s1_infoWallet.setVisible(false);
	s2_selectDice.setVisible(true);
...
void screen_flow_walletView::btnDiceSelectPressed()
{
	if((cuvex.wallet.dice_selected[0] != 0) && (cuvex.wallet.dice_selected[1] != 0) && (cuvex.wallet.dice_selected[2] != 0) && (cuvex.wallet.dice_selected[3] != 0))
	{
		...
		s2_selectDice.setVisible(false);
		s3_getWords.setVisible(true);
...
void screen_flow_walletView::btnGetWordsPressed()
{
	...
	{
		s3_getWords.setVisible(false);
		s4_typePassprhase.setVisible(true);
	}
...
void screen_flow_walletView::enterKeyboard2Pressed()
{
	...
	if((getSeedBIP39() == SUCCESS) && (getPrivateKey() == SUCCESS) && (getPublicKey() == SUCCESS))
	{
		...
		/*** Selecting visible/hidden elements on the screen ***/
		s4_typePassprhase.setVisible(false);
		s5_walletSuccess.setVisible(true);
	}
	else
	{
		/*** Selecting visible/hidden elements on the screen ***/
		s4_typePassprhase.setVisible(false);
		s6_walletError.setVisible(true);
	}
 ...
 ***** Response 	: N/A
 **************************************************************************************************************************************/
void screen_flow_walletView::btnConnectAppMsgPressed()
{
	/*** Selecting visible/hidden elements on the screen ***/
	s0_connectAppMsg.setVisible(false);
	s1_infoWallet.setVisible(true);

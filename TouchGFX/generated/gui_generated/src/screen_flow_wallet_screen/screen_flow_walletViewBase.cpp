    ...
    frameCountTickEventInterval(0)
{
    ...
    btn_connect_app_msg.setText(TypedText(T_SW_CONNECT_APP_MSG_BTN));
    ...
    connect_app_msg_text.setTypedText(touchgfx::TypedText(T_SW_CONNECT_APP_MSG));
    ...
    s1_infoWallet.setPosition(0, 0, 320, 240);
    ...
    s1_infoWallet.add(btn_info_wallet);
    ...
    s1_infoWallet.add(text_info_wallet_1);
    ...
    s1_infoWallet.add(text_info_wallet_2);

    add(s1_infoWallet);

    s2_selectDice.setPosition(0, 0, 320, 240);
    ...
    s2_selectDice.add(btn_dice_selected);

    box_dice_1.setXY(23, 40);
    s2_selectDice.add(box_dice_1);

    box_dice_2.setXY(93, 40);
    s2_selectDice.add(box_dice_2);

    box_dice_3.setXY(163, 40);
    s2_selectDice.add(box_dice_3);

    box_dice_4.setXY(233, 40);
    s2_selectDice.add(box_dice_4);

    box_dice_5.setXY(23, 120);
    s2_selectDice.add(box_dice_5);

    box_dice_6.setXY(93, 120);
    s2_selectDice.add(box_dice_6);

    box_dice_7.setXY(163, 120);
    s2_selectDice.add(box_dice_7);

    box_dice_8.setXY(233, 120);
    s2_selectDice.add(box_dice_8);
    ...
    s2_selectDice.add(text_dice_select_info);

    add(s2_selectDice);

    s3_getWords.setPosition(0, 0, 320, 240);
    ...
    s3_getWords.add(btn_get_words_selected);
    ...
    s3_getWords.add(text_get_words_info);
    ...
    s3_getWords.add(heads_or_tails);
    ...
    s3_getWords.add(word24);

    add(s3_getWords);

    s4_typePassprhase.setPosition(0, 0, 320, 240);
    s4_typePassprhase.setVisible(false);
    keyboard2.setXY(0, 117);
    keyboard2.setVisible(false);
    s4_typePassprhase.add(keyboard2);
    ...
    s4_typePassprhase.add(keyboard2_btn_show);
    ...
    s4_typePassprhase.add(keyboard2_btn_enter);
    ...
    s4_typePassprhase.add(keyboard2_text_typed);
    ...
    s4_typePassprhase.add(keyboard2_text_info_1);
    ...
    s4_typePassprhase.add(keyboard2_text_info_2);
    ...
    s4_typePassprhase.add(keyboard2_btn_up);
    ...
    s4_typePassprhase.add(keyboard2_btn_down);
    ...
    s4_typePassprhase.add(keyboard2_char_count);

    add(s4_typePassprhase);

    s5_walletSuccess.setPosition(0, 0, 320, 240);
    s5_walletSuccess.setVisible(false);
    ...
    s5_walletSuccess.add(btn_encrypt_info);
    ...
    s5_walletSuccess.add(btn_scroll_down_info);
    ...
    s5_walletSuccess.add(btn_scroll_up_info);
    ...
    s5_walletSuccess.add(scrollable_container_typed_check_info);

    add(s5_walletSuccess);

    s6_walletError.setPosition(0, 0, 320, 240);
    s6_walletError.setVisible(false);
    ...
    s6_walletError.add(btn_restart);

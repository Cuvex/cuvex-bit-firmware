...
This project is the source code of the **Firmware** that is installed on the Cuvex Bit device. You can access and download everything necessary to configure and compile the project at the following links:

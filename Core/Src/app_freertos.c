...
/* Definitions for mainToFpQueue */
osMessageQueueId_t mainToFpQueueHandle;
const osMessageQueueAttr_t mainToFpQueue_attributes = {
  .name = "mainToFpQueue"
};
/* Definitions for fpToMainQueue */
osMessageQueueId_t fpToMainQueueHandle;
const osMessageQueueAttr_t fpToMainQueue_attributes = {
  .name = "fpToMainQueue"
};
...
extern void fingerprint_Task(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of mainToFpQueue */
  mainToFpQueueHandle = osMessageQueueNew (5, sizeof(uint16_t), &mainToFpQueue_attributes);
  /* creation of fpToMainQueue */
  fpToMainQueueHandle = osMessageQueueNew (5, sizeof(uint16_t), &fpToMainQueue_attributes);
  ...
  fingerprintTaskHandle = osThreadNew(fingerprint_Task, NULL, &fingerprintTask_attributes);

    ...
    flexButtonCallback(this, &screen_flow_encrypt_part_1ViewBase::flexButtonCallbackHandler)
{
    ...
    btn_connect_app_msg.setText(TypedText(T_SE_CONNECT_APP_MSG_BTN));
    ...
    connect_app_msg_text.setTypedText(touchgfx::TypedText(T_SE_CONNECT_APP_MSG));
    ...
    s1_menuSelection.setPosition(0, 0, 320, 240);
    ...
    btn_plain_text.setText(TypedText(T_SE_MENU_BTN_PLAIN_TEXT));
    ...
    s1_menuSelection.add(btn_plain_text);
    ...
    btn_seed_xmr.setText(TypedText(T_SE_MENU_BTN_SEED_XMR));
    ...
    s1_menuSelection.add(btn_seed_xmr);
    ...
    btn_seed_slip39.setText(TypedText(T_SE_MENU_BTN_SEED_SLIP39));
    ...
    s1_menuSelection.add(btn_seed_slip39);
    ...
    btn_seed_bip39.setText(TypedText(T_SE_MENU_BTN_SEED_BIP39));
    ...
    s1_menuSelection.add(btn_seed_bip39);

    add(s1_menuSelection);

    s2_menuContent.setPosition(0, 0, 320, 240);
    s2_menuContent.setVisible(false);
    s2_seed.setPosition(0, 0, 320, 240);
    s2_seed.setVisible(false);
    s2_seed_1_typeNumWords.setPosition(0, 0, 320, 240);
    keyboard1_seed.setXY(0, 117);
    keyboard1_seed.setVisible(false);
    s2_seed_1_typeNumWords.add(keyboard1_seed);
    ...
    s2_seed_1_typeNumWords.add(keyboard1_btn_hide_seed);

    keyboard1_text_area_seed.setXY(45, 120);
    s2_seed_1_typeNumWords.add(keyboard1_text_area_seed);
    ...
    s2_seed_1_typeNumWords.add(keyboard1_btn_show_seed);
    ...
    s2_seed_1_typeNumWords.add(keyboard1_btn_enter_seed);
    ...
    Unicode::snprintf(keyboard1_text_typed_seedBuffer, KEYBOARD1_TEXT_TYPED_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD1_TYPED_VALUE).getText());
    keyboard1_text_typed_seed.setWildcard(keyboard1_text_typed_seedBuffer);
    keyboard1_text_typed_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD1_TYPED));
    s2_seed_1_typeNumWords.add(keyboard1_text_typed_seed);
    ...
    keyboard1_text_info_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD1_INFO));
    s2_seed_1_typeNumWords.add(keyboard1_text_info_seed);

    s2_seed.add(s2_seed_1_typeNumWords);

    s2_seed_2_typeWords.setPosition(0, 0, 320, 240);
    s2_seed_2_typeWords.setVisible(false);
    keyboard2_seed.setXY(0, 117);
    keyboard2_seed.setVisible(false);
    s2_seed_2_typeWords.add(keyboard2_seed);
    ...
    s2_seed_2_typeWords.add(keyboard2_btn_hide_seed);

    keyboard2_text_area_seed.setXY(45, 120);
    s2_seed_2_typeWords.add(keyboard2_text_area_seed);
    ...
    s2_seed_2_typeWords.add(keyboard2_btn_show_seed);
    ...
    s2_seed_2_typeWords.add(keyboard2_btn_enter_seed);
    ...
    Unicode::snprintf(keyboard2_text_typed_seedBuffer, KEYBOARD2_TEXT_TYPED_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD2_TYPED_VALUE).getText());
    keyboard2_text_typed_seed.setWildcard(keyboard2_text_typed_seedBuffer);
    keyboard2_text_typed_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD2_TYPED));
    s2_seed_2_typeWords.add(keyboard2_text_typed_seed);
    ...
    Unicode::snprintf(keyboard2_text_predicted_seedBuffer, KEYBOARD2_TEXT_PREDICTED_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD2_TYPED_VALUE).getText());
    keyboard2_text_predicted_seed.setWildcard(keyboard2_text_predicted_seedBuffer);
    keyboard2_text_predicted_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD2_PREDICTED));
    keyboard2_text_predicted_seed.setVisible(false);
    s2_seed_2_typeWords.add(keyboard2_text_predicted_seed);
    ...
    touchgfx::Unicode::snprintf(keyboard2_text_info_seedBuffer1, KEYBOARD2_TEXT_INFO_SEEDBUFFER1_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD2_INFO_ACTUAL_WORD_VALUE).getText());
    keyboard2_text_info_seed.setWildcard1(keyboard2_text_info_seedBuffer1);
    touchgfx::Unicode::snprintf(keyboard2_text_info_seedBuffer2, KEYBOARD2_TEXT_INFO_SEEDBUFFER2_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD2_INFO_TOTAL_WORDS_VALUE).getText());
    keyboard2_text_info_seed.setWildcard2(keyboard2_text_info_seedBuffer2);
    keyboard2_text_info_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD2_INFO));
    s2_seed_2_typeWords.add(keyboard2_text_info_seed);

    s2_seed.add(s2_seed_2_typeWords);

    s2_seed_3_typePassphrase.setPosition(0, 0, 320, 240);
    s2_seed_3_typePassphrase.setVisible(false);
    keyboard3_seed.setXY(0, 117);
    keyboard3_seed.setVisible(false);
    s2_seed_3_typePassphrase.add(keyboard3_seed);
    ...
    s2_seed_3_typePassphrase.add(keyboard3_btn_hide_seed);
    ...
    s2_seed_3_typePassphrase.add(keyboard3_text_area_seed);
    ...
    s2_seed_3_typePassphrase.add(keyboard3_btn_show_seed);
    ...
    keyboard3_btn_enter_seed.setText(TypedText(T_SE_KEYBOARD3_BTN_ENTER));
    ...
    s2_seed_3_typePassphrase.add(keyboard3_btn_enter_seed);
    ...
    Unicode::snprintf(keyboard3_text_typed_seedBuffer, KEYBOARD3_TEXT_TYPED_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD3_TYPED_VALUE).getText());
    keyboard3_text_typed_seed.setWildcard(keyboard3_text_typed_seedBuffer);
    keyboard3_text_typed_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD3_TYPED));
    s2_seed_3_typePassphrase.add(keyboard3_text_typed_seed);
    ...
    keyboard3_text_info_1_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD3_INFO_1));
    s2_seed_3_typePassphrase.add(keyboard3_text_info_1_seed);
    ...
    keyboard3_text_info_2_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD3_INFO_2));
    s2_seed_3_typePassphrase.add(keyboard3_text_info_2_seed);
    ...
    s2_seed_3_typePassphrase.add(keyboard3_btn_up_seed);
    ...
    s2_seed_3_typePassphrase.add(keyboard3_btn_down_seed);
    ...
    Unicode::snprintf(keyboard3_char_count_seedBuffer, KEYBOARD3_CHAR_COUNT_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD3_CHAR_COUNT_VALUE).getText());
    keyboard3_char_count_seed.setWildcard(keyboard3_char_count_seedBuffer);
    keyboard3_char_count_seed.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD3_CHAR_COUNT));
    keyboard3_char_count_seed.setAlpha(200);
    s2_seed_3_typePassphrase.add(keyboard3_char_count_seed);

    s2_seed.add(s2_seed_3_typePassphrase);

    s2_menuContent.add(s2_seed);

    s2_plainText.setPosition(0, 0, 320, 240);
    s2_plainText.setVisible(false);
    s2_plainText_1_typePlainText.setPosition(0, 0, 320, 240);
    keyboard_plain_text.setXY(0, 117);
    keyboard_plain_text.setVisible(false);
    s2_plainText_1_typePlainText.add(keyboard_plain_text);
    ...
    s2_plainText_1_typePlainText.add(keyboard_btn_hide_plain_text);
    ...
    s2_plainText_1_typePlainText.add(keyboard_text_area_plain_text);
    ...
    s2_plainText_1_typePlainText.add(keyboard_btn_show_plain_text);
    ...
    keyboard_btn_enter_plain_text.setText(TypedText(T_SE_KEYBOARD4_BTN_ENTER));
    ...
    s2_plainText_1_typePlainText.add(keyboard_btn_enter_plain_text);
    ...
    Unicode::snprintf(keyboard_text_typed_plain_textBuffer, KEYBOARD_TEXT_TYPED_PLAIN_TEXT_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD4_TYPED_VALUE).getText());
    keyboard_text_typed_plain_text.setWildcard(keyboard_text_typed_plain_textBuffer);
    keyboard_text_typed_plain_text.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD4_TYPED));
    s2_plainText_1_typePlainText.add(keyboard_text_typed_plain_text);
    ...
    keyboard_text_info_plain_text.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD4_INFO));
    s2_plainText_1_typePlainText.add(keyboard_text_info_plain_text);
    ...
    s2_plainText_1_typePlainText.add(keyboard_btn_up_plain_text);
    ...
    s2_plainText_1_typePlainText.add(keyboard_btn_down_plain_text);
    ...
    Unicode::snprintf(keyboard_char_count_plain_textBuffer, KEYBOARD_CHAR_COUNT_PLAIN_TEXT_SIZE, "%s", touchgfx::TypedText(T_SE_KEYBOARD4_CHAR_COUNT_VALUE).getText());
    keyboard_char_count_plain_text.setWildcard(keyboard_char_count_plain_textBuffer);
    keyboard_char_count_plain_text.setTypedText(touchgfx::TypedText(T_SE_KEYBOARD4_CHAR_COUNT));
    keyboard_char_count_plain_text.setAlpha(200);
    s2_plainText_1_typePlainText.add(keyboard_char_count_plain_text);

    s2_plainText.add(s2_plainText_1_typePlainText);

    s2_menuContent.add(s2_plainText);

    s2_checkInfo.setPosition(0, 0, 320, 240);
    ...
    btn_encrypt.setText(TypedText(T_SE_BTN_ENCRYPT_SEED));
    ...
    s2_checkInfo.add(btn_encrypt);

    s2_checkInfo_Seed.setPosition(0, 0, 320, 240);
    s2_checkInfo_Seed.setVisible(false);
    ...
    s2_checkInfo_Seed.add(btn_scroll_down_seed);
    ...
    s2_checkInfo_Seed.add(btn_scroll_up_seed);
    ...
    Unicode::snprintf(typed_check_seedBuffer, TYPED_CHECK_SEED_SIZE, "%s", touchgfx::TypedText(T_SE_TYPED_SEED_CHECK_VALUE).getText());
    typed_check_seed.setWildcard(typed_check_seedBuffer);
    typed_check_seed.setTypedText(touchgfx::TypedText(T_SE_TYPED_SEED_CHECK));
    scrollable_container_typed_check_seed.add(typed_check_seed);

    s2_checkInfo_Seed.add(scrollable_container_typed_check_seed);

    s2_checkInfo.add(s2_checkInfo_Seed);

    s2_checkInfo_PlainText.setPosition(0, 0, 320, 240);
    s2_checkInfo_PlainText.setVisible(false);
    ...
    s2_checkInfo_PlainText.add(btn_scroll_down_plain_text);
    ...
    s2_checkInfo_PlainText.add(btn_scroll_up_plain_text);
    ...
    Unicode::snprintf(typed_check_plain_textBuffer, TYPED_CHECK_PLAIN_TEXT_SIZE, "%s", touchgfx::TypedText(T_SE_TYPED_PLAIN_TEXT_CHECK_VALUE).getText());
    typed_check_plain_text.setWildcard(typed_check_plain_textBuffer);
    typed_check_plain_text.setTypedText(touchgfx::TypedText(T_SE_TYPED_PLAIN_TEXT_CHECK));
    scrollable_container_typed_check_plain_text.add(typed_check_plain_text);

    s2_checkInfo_PlainText.add(scrollable_container_typed_check_plain_text);

    s2_checkInfo.add(s2_checkInfo_PlainText);

    s2_menuContent.add(s2_checkInfo);
